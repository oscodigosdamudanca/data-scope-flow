...
-- 1. Criar tabela module_permissions
...
-- 3. Criar política para desenvolvedores (acesso total)
...
-- 4. Criar política para administradores (apenas leitura das próprias permissões)
...
-- 6. Função para verificar permissões de módulo
...
-- 7. Função para obter permissões de um role
...
SELECT COUNT(*) as total_permissions FROM public.module_permissions;